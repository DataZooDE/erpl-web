...
// Type: Theobald.Extractors.OdpOData.ContainerFormatException
...
public class ContainerFormatException(string format) : Exception($"Default container does not support required data format `{format}`")
{
}
