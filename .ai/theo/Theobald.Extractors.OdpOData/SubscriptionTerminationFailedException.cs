...
// Type: Theobald.Extractors.OdpOData.SubscriptionTerminationFailedException
...
public class SubscriptionTerminationFailedException : Exception
{
  public SubscriptionTerminationFailedException()
    : base("Termination of delta subscription failed: the SAP system indicated failure")
  {
  }
}
