...
// Type: Theobald.Extractors.OdpOData.SingleValueFilterNotAllowedException
...
public sealed class SingleValueFilterNotAllowedException(string fieldName) : Exception($"Field `{fieldName}` does not allow single value filtering")
{
