...
// Type: Theobald.Extractors.OdpOData.ODataErrorResponseException
...
public class ODataErrorResponseException(HttpStatusCode httpStatusCode, Error error) : Exception($"Server indicated an error ({httpStatusCode}): {error.Message.Value}")
{
