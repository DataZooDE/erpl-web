...
// Type: Theobald.Extractors.OdpOData.ODataXmlRootElementMissingException
...
public class ODataXmlRootElementMissingException : Exception
{
  public ODataXmlRootElementMissingException()
    : base("OData XML root element \"edmx:Edmx\" or \"edmx:DataServices\" missing")
  {
  }
}
