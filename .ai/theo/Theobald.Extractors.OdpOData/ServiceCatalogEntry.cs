...
// Type: Theobald.Extractors.OdpOData.ServiceCatalogEntry
...
public readonly struct ServiceCatalogEntry
{
  ...
  public required IReadOnlyList<string> EntitySets { get; init; }
}
