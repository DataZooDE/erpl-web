...
// Type: Theobald.Extractors.OdpOData.NoFieldsSelectedException
...
public class NoFieldsSelectedException : Exception
{
  public NoFieldsSelectedException()
    : base("No fields were selected for output")
  {
  }
}
