...
// Type: Theobald.Extractors.OdpOData.PropertyTypeNotSupportedException
...
public class PropertyTypeNotSupportedException(string typeName) : NotSupportedException($"Type {typeName} is not supported")
{
