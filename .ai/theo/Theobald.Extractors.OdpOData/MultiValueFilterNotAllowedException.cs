...
// Type: Theobald.Extractors.OdpOData.MultiValueFilterNotAllowedException
...
public sealed class MultiValueFilterNotAllowedException(string fieldName) : Exception($"Field `{fieldName}` does not allow multi-value filtering")
{
