...
// Type: Theobald.Extractors.OdpOData.LookupUrl
...
public readonly struct LookupUrl : IODataUrl
{
  public required string SearchPattern { get; init; }

  public string AsUrl(string baseUrl)
  {
    return baseUrl + $"sap/opu/odata/IWFND/CATALOGSERVICE;v=2/ServiceCollection?search={this.SearchPattern}&$format=json&$expand=EntitySets";
  }
}
