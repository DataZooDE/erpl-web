...
// Type: Theobald.Extractors.OdpOData.EntityTypeNotFoundException
...
public class EntityTypeNotFoundException(NamedRef typeRef) : Exception($"Entity type `{typeRef}` not found")
{
