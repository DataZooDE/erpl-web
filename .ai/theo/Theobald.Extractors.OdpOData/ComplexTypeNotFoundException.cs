...
// Type: Theobald.Extractors.OdpOData.ComplexTypeNotFoundException
...
public class ComplexTypeNotFoundException(NamedRef typeRef) : Exception($"Complex type `{typeRef}` not found")
{
