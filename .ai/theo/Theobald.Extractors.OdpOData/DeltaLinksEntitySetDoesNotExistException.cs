...
// Type: Theobald.Extractors.OdpOData.DeltaLinksEntitySetDoesNotExistException
...
public class DeltaLinksEntitySetDoesNotExistException(string name) : Exception($"Entity set `DeltaLinksOf{name}` does not exist for service.")
{
