...
// Type: Theobald.Extractors.OdpOData.PropertyNotFoundException
...
public class PropertyNotFoundException(NamedRef propertyRef) : Exception($"EntityType does not contain a property named '{propertyRef.Name}'")
{
  public NamedRef PropertyRef { get; } = propertyRef;
}
