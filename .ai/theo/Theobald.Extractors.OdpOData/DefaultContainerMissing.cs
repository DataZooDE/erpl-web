...
// Type: Theobald.Extractors.OdpOData.DefaultContainerMissing
...
public class DefaultContainerMissing : Exception
{
  public DefaultContainerMissing()
    : base("A default entity set container is required")
  {
  }
}
