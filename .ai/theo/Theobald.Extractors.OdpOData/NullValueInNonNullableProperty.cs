...
// Type: Theobald.Extractors.OdpOData.NullValueInNonNullableProperty
...
public class NullValueInNonNullableProperty(string name) : Exception($"Null value for non-nullable property \"{name}\"")
{
}
