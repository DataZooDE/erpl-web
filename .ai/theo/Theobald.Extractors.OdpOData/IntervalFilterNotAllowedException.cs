...
// Type: Theobald.Extractors.OdpOData.IntervalFilterNotAllowedException
...
public sealed class IntervalFilterNotAllowedException(string fieldName) : Exception($"Field `{fieldName}` does not allow filtering for value ranges")
{
