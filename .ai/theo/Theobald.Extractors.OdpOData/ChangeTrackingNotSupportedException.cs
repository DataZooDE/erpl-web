...
// Type: Theobald.Extractors.OdpOData.ChangeTrackingNotSupportedException
...
public sealed class ChangeTrackingNotSupportedException : Exception
{
  public ChangeTrackingNotSupportedException()
    : base("Service does not support change tracking")
  {
  }
}
