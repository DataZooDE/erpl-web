...
// Type: Theobald.Extractors.OdpOData.RequiredAttributeMissingException
...
public class RequiredAttributeMissingException(string name) : Exception($"Node does not contain {name} attribute")
{
