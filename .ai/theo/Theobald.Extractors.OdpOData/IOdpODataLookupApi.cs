...
// Type: Theobald.Extractors.OdpOData.IOdpODataLookupApi
...
public interface IOdpODataLookupApi
{
  Task<List<ServiceCatalogEntry>> SearchAsync(LookupUrl url, CancellationToken cancellationToken);
}
