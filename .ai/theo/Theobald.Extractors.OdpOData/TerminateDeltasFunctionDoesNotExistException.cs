...
// Type: Theobald.Extractors.OdpOData.TerminateDeltasFunctionDoesNotExistException
...
public class TerminateDeltasFunctionDoesNotExistException(string name) : Exception($"Function import `TerminateDeltasFor{name}` does not exist for service")
{
